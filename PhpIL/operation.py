...
class LoadInteger(Operation):
    ...
    def __str__(self):
        return "out0 = " + Opcode.opcodeList[self.opcode] + " " + "'" + str(self.value) + "'"
...
class BeginWhile(Operation):
    ...
    def __str__(self):
        ...
        return Opcode.opcodeList[self.opcode] + input
...
class UnaryOperation(Operation):
    ...
    def __str__(self):
        return "out0 = " + Opcode.opcodeList[self.opcode] + " " + str(self.op) + " inp0"
...
class BinaryOperation(Operation):
    ...
    def __str__(self):
        return "out0 = " + Opcode.opcodeList[self.opcode] + " inp0, " + str(self.op) + " ,inp1"
